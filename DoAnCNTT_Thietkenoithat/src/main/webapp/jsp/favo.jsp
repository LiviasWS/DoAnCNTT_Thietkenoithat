                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="#" class="btn-unlike"><img src="${pageContext.request.contextPath}/images/unlike.png"></a></td>
                        </tr>
                ...
                <div class="col-md-6">
                  <div class="row mb-5">
                    <div class="col-md-6 mb-3 mb-md-0">
                      <button class="btn btn-black btn-sm btn-block" onclick="window.location='${pageContext.request.contextPath}/jsp/cart.jsp'">Go to Cart</button>
                    </div>
